...
export class GroupSitemapArchParser {
    parse(arch, models, modelName, jsClass) {
        ...
        visitXML(arch, (node) => {
            if (node.tagName === "button") {
                ...
                const fieldInfo = Field.parseFieldNode(node, models, modelName, "sitemap", jsClass);
...
export class SitemapArchParser {
    parseFieldNode(node, models, modelName) {
        return Field.parseFieldNode(node, models, modelName, "sitemap");
    }
    ...
    parse(xmlDoc, models, modelName) {
        ...
        let headerButtons = [];
        const creates = [];
        const groupSitemapArchParser = new GroupSitemapArchParser();
        let buttonGroup;
        ...
        visitXML(xmlDoc, (node) => {
            ...
            if (node.tagName === "button") {
                ...
                const groupByArchInfo = groupSitemapArchParser.parse(node, models, coModelName);
