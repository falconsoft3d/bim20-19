...
class BimRequisitionSpace(models.TransientModel):
    ...
    location_type = fields.Selection([('project','Project Location'),('main_location','Main Locations'),('combination','Project/ Main All')])
    purchase_type = fields.Selection([('wo_stock', 'Purchase without Stock'),('wi_stock', 'Purchase with Stock')],'Purchase Type', default='wo_stock')
