...
class BimAjustBudgetWzd(models.TransientModel):
    ...
    amount = fields.Float(string="Amount", digits="BIM price")
    new_amount = fields.Float(string="New Amount", digits="BIM price")
    fixed = fields.Float(string="Fixed Amount", digits="BIM price")
    percent = fields.Float(string="Percentage", digits=(10, 2))
