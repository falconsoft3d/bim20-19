...
class LoadWeekHoursLine(models.TransientModel):
    ...
    hours1 = fields.Float('Monday', digits=(10, 2))
    hours2 = fields.Float('Tuesday', digits=(10, 2))
    hours3 = fields.Float('Wednesday', digits=(10, 2))
    hours4 = fields.Float('Thursday', digits=(10, 2))
    hours5 = fields.Float('Friday', digits=(10, 2))
    hours6 = fields.Float('Saturday', digits=(10, 2))
    hours7 = fields.Float('Monday 2', digits=(10, 2))
    extra1 = fields.Float('Monday Extra', digits=(10, 2))
    extra2 = fields.Float('Tuesday Extra', digits=(10, 2))
    extra3 = fields.Float('Wednesday Extra', digits=(10, 2))
    extra4 = fields.Float('Thursday Extra', digits=(10, 2))
    extra5 = fields.Float('Friday Extra', digits=(10, 2))
